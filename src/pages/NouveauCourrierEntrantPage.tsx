// src/pages/NouveauCourrierEntrantPage.tsx
...
export const NouveauCourrierEntrantPage: React.FC = () => {
  ...
  const [modeReception, setModeReception] = useState('');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!typeMatch) { setError(`Type "Entrant" introuvable. Types: ${types.map((t: any) => t.libelle).join(', ')}`); setSending(false); return; }
